...
| jump to left or right edge | move cursor to the left (minX) or right (maxX) edge of the view                                         | Pos1/Home and End                                                   |
...
| center cursor              | reorientates the view, that the cursor is in the center                                                 | ctrl+Z (cmd+Z on Mac)                                               |
| zoom in/out (both axes)    | rescales both axes to enlarge or shrink the view around its center                                      | Z and shift+Z (may hold)                                            |
| zoom in/out (only X-axis)  | rescales only in the X-axis to enlarge or shrink the view around its center (only minX and maxX change) | X+(Z or shift+Z)                                                    |
| zoom in/out (only Y-axis)  | rescales only in the Y-axis to enlarge or shrink the view around its center (only minY and maxY change) | Y+(Z or shift+Z)                                                    |
